...
const hihgScoreElement = document.querySelector(".high-score");
...
hihgScoreElement.innerHTML = `High Score: ${highScore}`;
...
const initGame = () => {
	...
	for (let i = snakeBody.length - 1; i > 0; i--) {
		// Shifting forward the values of the elements in the snake body in one
